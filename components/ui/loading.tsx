...
export default function Loading({
    className = "faceIn flex w-full"
}: {
    className?: string,
}) {

    return (
        <div className={cn(className, "stroke-primary justify-center items-center rounded-lg")}>
            <svg className={"animate-spin h-16 w-16"} width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
